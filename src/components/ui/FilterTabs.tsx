      ...
      {tabs.map((tab) => {
        ...
        return (
          <button
            ...
            className={
              isActive
                ? "border text-brand-dark bg-profile-accent lg:bg-transparent lg:border-profile-accent/45 lg:text-profile-accent uppercase font-manrope font-normal text-[13px] tracking-[0.2em] px-4.5 py-2.5 rounded-4xl lg:rounded-sm"
