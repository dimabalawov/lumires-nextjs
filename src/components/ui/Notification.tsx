...
import { typeIcon } from "@/lib/signalr/notifications/getBadge";
                    ...
                    <div className="p-3 pb-2">
                        <div className="flex items-center gap-2.5">
                            <div className="relative shrink-0">
                                ...
                                {t.type && typeIcon[t.type as NotificationType] && (() => {
                                    const { Icon, color } = typeIcon[t.type as NotificationType];
                                    return (
                        ...
                        <div className="flex items-center justify-between mt-1.5 ml-11.5">
                            ...
                            {t.targetUrl && (
                                <Link
                                    href={t.targetUrl}
                                    className="flex items-center gap-1 text-[12px] text-white/70 border border-white/20 rounded-md px-3 py-0.5 hover:bg-white/10 transition-colors"
                                >
                                    View →
                                </Link>
                            )}
